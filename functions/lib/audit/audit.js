...
exports.addAuditLog = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
exports.addAuditLog = functions.https.onCall(async (data, context) => {
    ...
    if (typeof data !== 'object' || data === null) {
        throw new functions.https.HttpsError("invalid-argument", "Os dados devem ser um objeto.");
    }
    const { action, targetId, targetType } = data;
    if (!action || !targetId || !targetType) {
        throw new functions.https.HttpsError("invalid-argument", "Dados insuficientes para o log de auditoria.");
    }
    const auditData = {
        ...data,
    ...
    try {
        ...
        throw new functions.https.HttpsError("internal", "Erro interno ao salvar o log.");
    }
});
